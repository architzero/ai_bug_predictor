...
BUG_TYPE_KEYWORDS = {
    "null_pointer": [
        "null pointer", "nullpointerexception", "nonetype",
        "none has no attribute", "attributeerror: none",
        "crash when null", "crash when none",
        "null reference", "dereference null",
    ],
    "memory_leak": [
        "memory leak", "leak", "memory", "free", "deallocate", "malloc",
        "garbage collection", "gc", "out of memory", "oom"
    ],
    "race_condition": [
        "race condition", "race", "concurrent", "thread", "synchronization",
        "mutex", "lock", "deadlock", "atomic", "volatile"
    ],
    "index_error": [
        "index out of bounds", "index error", "array index", "out of bounds",
        "bounds check", "indexoutofbounds", "arrayindexoutofbounds"
    ],
    "type_error": [
        "type error", "type mismatch", "conversion", "cast", "parse",
        "format", "invalid type", "typeerror"
    ],
    "logic": [
        "wrong result", "incorrect result", "off by one",
        "returns wrong", "wrong value", "incorrect behavior",
        "assertion failed", "unexpected behavior", "wrong output",
        "incorrect calculation", "wrong condition", "inverted condition",
    ],
    "security": [
        "security", "vulnerability", "injection", "xss", "csrf", "auth",
        "authentication", "authorization", "encryption", "crypto"
    ],
    "performance": [
        "performance", "slow", "optimize", "bottleneck", "latency",
        "throughput", "efficiency", "speed", "fast"
    ],
    "crash": [
    ...
    "resource": [
        "resource", "file not found", "connection", "timeout", "network",
        "socket", "io", "stream", "resource leak"
    ]
}
